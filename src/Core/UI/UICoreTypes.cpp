...
void UIBase::Update()
{
    ...
    // Update button state.
    if (CoreUtility::Utility::CollisionBetweenPointAndRectangle(m_BaseRectangle, CoreMath::Vec2i(iMouseX, iMouseY)))
    {
        // Hover
...
{
    return CoreManagers::g_AssetManager.m_FontAssets[CoreSystems::StringToHash32(std::string("fnt_Orbitron"))].m_Font;
}
